...
function M.setup()
	...
	local groups = {
		...
		["CmpItemKindColor"] = { fg = palette.light },
		["CmpItemKindConstant"] = { fg = palette.light },
		["CmpItemKindConstructor"] = { fg = palette.purple },
		["CmpItemKindEnum"] = { fg = palette.orange },
		["CmpItemKindEnumMember"] = { fg = palette.blue },
		["CmpItemKindEvent"] = { fg = palette.light },
		["CmpItemKindField"] = { fg = palette.blue },
		["CmpItemKindFile"] = { fg = palette.light },
		["CmpItemKindFolder"] = { fg = palette.yellow },
		["CmpItemKindFunction"] = { fg = palette.purple },
		["CmpItemKindInterface"] = { fg = palette.blue },
		["CmpItemKindKeyword"] = { fg = palette.light },
		["CmpItemKindMethod"] = { fg = palette.purple },
		["CmpItemKindModule"] = { fg = palette.light },
		["CmpItemKindOperator"] = { fg = palette.light },
		["CmpItemKindProperty"] = { fg = palette.blue },
		["CmpItemKindReference"] = { fg = palette.light },
		["CmpItemKindSnippet"] = { fg = palette.light },
		["CmpItemKindSnippetFunction"] = { fg = palette.light },
		["CmpItemKindSnippetStruct"] = { fg = palette.light },
		["CmpItemKindStruct"] = { fg = palette.light },
		["CmpItemKindText"] = { fg = palette.light },
		["CmpItemKindTypeParameter"] = { fg = palette.light },
		["CmpItemKindUnit"] = { fg = palette.light },
		...
		["CmpMenuSel"] = { bg = palette.blue, fg = palette.light },
	}
