...
function M.setup()
    ...
    local groups = {
        ...
        ["@constant.builtin"]       = { link = "Type", bold = true }, -- Built-in constant values: `nil` in Lua.
        ...
        ["@type"]                   = { fg = palette.light_blue, bold = true }, -- Type (and class) definitions and annotations.
